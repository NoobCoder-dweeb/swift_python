...
DEFAULT_STRESS_SCENARIOS: list[StressScenario] = [
    ...
    StressScenario(
        name="how_much_total_word_quantity",
        subject="Product X pricing",
        body="How much total if I want twenty units of Product X?",
        expected_type="pricing",
        expected_status="pending",
        expected_quantity=20,
        required_terms=["Product X", "RM 120.00", "20 units", "RM 2400.00"],
        forbidden_terms=["unknown", "invented"],
        expect_valid=True,
    ),
    StressScenario(
        name="two_dozen_quote",
        subject="Product X quote",
        body="Can you quote two dozen units of Product X?",
        expected_type="pricing",
        expected_status="pending",
        expected_quantity=24,
        required_terms=["Product X", "24 units", "RM 2880.00"],
        forbidden_terms=["unknown", "invented"],
        expect_valid=True,
    ),
    StressScenario(
        name="can_i_buy_quantity",
        subject="Safety gloves purchase",
        body="Can I buy 20 safety gloves?",
        expected_type="pricing",
        expected_status="pending",
        expected_quantity=20,
        required_terms=["Safety Gloves", "20 units"],
        forbidden_terms=["only supports product pricing", "invented"],
        expect_valid=True,
    ),
    StressScenario(
        name="do_you_carry_product",
        subject="Safety gloves",
        body="Do you carry safety gloves?",
        expected_type="availability",
        expected_status="pending",
        required_terms=["Safety Gloves"],
        forbidden_terms=["only supports product pricing", "invented"],
        expect_valid=True,
    ),
    StressScenario(
        name="how_many_can_you_supply",
        subject="Safety gloves supply",
        body="How many safety gloves can you supply?",
        expected_type="availability",
        expected_status="pending",
        required_terms=["Safety Gloves"],
        forbidden_terms=["only supports product pricing", "invented"],
    ...
    StressScenario(
        name="malay_harga_pricing",
        subject="Safety gloves",
        body="Berapa harga untuk 20 safety gloves?",
        expected_type="pricing",
        expected_status="pending",
        expected_quantity=20,
        required_terms=["Safety Gloves", "20 units"],
